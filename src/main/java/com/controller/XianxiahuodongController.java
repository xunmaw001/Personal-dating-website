...
public class XianxiahuodongController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XianxiahuodongEntity xianxiahuodong, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XianxiahuodongEntity xianxiahuodong, HttpServletRequest request){
        EntityWrapper<XianxiahuodongEntity> ew = new EntityWrapper<XianxiahuodongEntity>();
    	PageUtils page = xianxiahuodongService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xianxiahuodong), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
