...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">交友信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>交友信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">交友信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gerenyouxiang')">个人邮箱<i id="gerenyouxiangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('aihao')">爱好<i id="aihaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tezhang')">特长<i id="tezhangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var gerenyouxiangCell  = document.createElement('td');

						 gerenyouxiangCell.innerHTML = item.gerenyouxiang;


			row.appendChild(gerenyouxiangCell);
			var aihaoCell  = document.createElement('td');

						 aihaoCell.innerHTML = item.aihao;


			row.appendChild(aihaoCell);
			var tezhangCell  = document.createElement('td');

						 tezhangCell.innerHTML = item.tezhang;


			row.appendChild(tezhangCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaoyouxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiaoyouxinxi");
